...
// ...
	...
	if (trustStore == NULL)
	{
		printf("Error in creating a new X509 store at checkCertificate\n");
		goto err;
	}

	rc = X509_STORE_add_cert(trustStore, caCert);
	if (rc != 1) {
		printf("Error in adding a certificate in trust store at checkCertificate\n");
		goto err;
	}
	...
	if (storeCtx == NULL)
	{
		printf("Error in creating a x509 store context at checkCertificate\n");
		goto err;
	}
	...
	if (rc != 1)
	{
		printf("Error in initiating store context for verfication at checkCertificate\n");
		goto err;
	}
	...
	if (rc != 1)
	{
		printf("Error in verifying store context at checkCertificate\n");
		goto err;
	}
	...
	if (rc != 1)
	{
		printf("Error in checking host at checkCertificate\n");
		goto err;
	}
